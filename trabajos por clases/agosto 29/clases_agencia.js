...
let ag = new Agencia (862656,'Renault')
console.log(ag)
...
let v = new vehiculo (862656,'Renault','1n2n3n','Toyota',2017,18000000,4,'vehiculo')
console.log(v)
...
class auto_compacto extends vehiculo {
 ...
 let twingo = new auto_compacto (862656,'Renault','414512gyu','volsvagen',2013,8000000,4,'Compacto',2)
console.log(twingo)
